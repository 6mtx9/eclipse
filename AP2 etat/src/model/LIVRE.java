...
public class LIVRE {
	...
	public LIVRE(String iSBN, String titre, float prix, AUTEUR auteur, ADHERENT emprunteur ,ETAT etat) {
		super();
		ISBN = iSBN;
		this.titre = titre;
		this.prix = prix;
	...
	public LIVRE(String iSBN, String titre, float prix, AUTEUR auteur, ETAT etat) {
		super();
		ISBN = iSBN;
		this.titre = titre;
		this.prix = prix;
	...
	public LIVRE(String iSBN, String titre, float prix, ETAT etat) {
		super();
		ISBN = iSBN;
		this.titre = titre;
		this.prix = prix;
